...
router.get('/auth/gmail', auth, requireRole(['professional', 'super_admin']), emailController.getGmailAuthUrl.bind(emailController));
router.get('/auth/gmail/callback', emailController.handleGmailCallback.bind(emailController));

router.get('/auth/outlook', auth, requireRole(['professional', 'super_admin']), emailController.getOutlookAuthUrl.bind(emailController));
