...
import digitalTwinService, { RAGConfig, KnowledgeBaseEntry } from './digitalTwinService';
    ...
    async performEnhancedRAGSearch(
        ...
        try {
            ...
            for (const query of searchQueries) {
                const kbVectorResults = await knowledgeSearchService.searchKnowledgeBaseWithAdaptiveFiltering(
